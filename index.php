...
echo "test";
        ...
        $videoid = $video_url;
        $listResponse = $youtube->videos->listVideos("statistics,snippet",array('id' => "9cBN9_9oK4A"));
...
<body>
<div class="header">
    <span><a style="text-decoration: blink;" href="../">MONETUBE</a></span><a href="logout.php">logout</a>
</div>
